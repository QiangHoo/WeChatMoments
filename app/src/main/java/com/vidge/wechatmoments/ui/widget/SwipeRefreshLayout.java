...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private void createProgressView() {
        ...
        CustomMaterialProgressDrawable progress = new CustomMaterialProgressDrawable(this);
        progress.setBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_moments));
...
//        mCircleView.layout((width / 6 - circleWidth / 2), mCurrentTargetOffsetTop,
//                (width / 6 + circleWidth / 2), mCurrentTargetOffsetTop + circleHeight);
        mCircleView.layout(childLeft + circleWidth, mCurrentTargetOffsetTop,
                childLeft + 2 * circleWidth, mCurrentTargetOffsetTop + circleHeight);
    }
    ...
    public void setProgressView(CustomMaterialProgressDrawable progressView) {
